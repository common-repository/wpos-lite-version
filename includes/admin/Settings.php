...
class Openpos_Settings {
    ...
    function admin_enqueue_scripts() {
        ...
        wp_enqueue_style( 'jquery.tagthis',WPOSL_URL.'/assets/css/tokenize2.min.css' );
        wp_enqueue_script('jquery.tagthis',WPOSL_URL.'/assets/js/tokenize2.min.js',array('jquery'));
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
               <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="exampleModalLabel"><?php echo __('Choose Categories','wpos-lite') ?></h4>
                </div>
                <div class="modal-body">

                    <form method="GET" id="frm-list-categories">
                        <div>
                            <select multiple="multiple" data-placeholder="<?php esc_attr_e( 'Select categories&hellip;', 'wpos-lite'); ?>" class="wc-enhanced-select" id="show_categories" name="show_categories[]" style="width: 100%;">
                                <?php
                                $r                 = array();
                                $r['pad_counts']   = 1;
                                $r['hierarchical'] = 1;
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo __('Close','wpos-lite') ?></button>
                    <button type="button" class="btn btn-primary  save-categories-popup"><?php echo __('Save changes','wpos-lite') ?></button>
                </div>
            </div>
             </div>
        </div>
