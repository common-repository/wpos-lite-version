...
?>
<div class="wrap">
    <h1><?php echo __( 'POS Cashiers', 'wpos-lite'); ?></h1>
    <form id="op-product-list"  onsubmit="return false;">
        <table id="grid-selection" class="table table-condensed table-hover table-striped op-product-grid">
            <thead>
            <tr>
                <th data-column-id="id" data-type="numeric" data-identifier="true" ><?php echo __( 'ID', 'wpos-lite'); ?></th>
                <th data-column-id="user_login" data-sortable="false"><?php echo __( 'Name', 'wpos-lite'); ?></th>
                <th data-column-id="user_email" data-sortable="false"><?php echo __( 'Email', 'wpos-lite'); ?></th>
                <th data-column-id="allow_pos" data-sortable="false"><?php echo __( 'Is POS Staff ?', 'wpos-lite'); ?></th>
            </tr>
            </thead>
        </table>
    </form>
