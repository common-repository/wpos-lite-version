...
?>
<div class="wrap">
    <h1><?php echo __( 'POS Orders', 'wpos-lite'); ?></h1>
    <form id="op-order-list"  onsubmit="return false;">
        <table id="grid-selection" class="table table-condensed table-hover table-striped op-product-grid">
            ...
            <tr>
                ...
                <th data-column-id="order_number" data-sortable="false"><?php echo __( 'Order', 'wpos-lite'); ?></th>
                <th data-column-id="created_at" data-identifier="true" data-type="numeric"><?php echo __( 'Date', 'wpos-lite'); ?></th>
                <th data-column-id="source" data-sortable="false"><?php echo __( 'Source', 'wpos-lite'); ?></th>
                <th data-column-id="created_by" data-sortable="false"><?php echo __( 'By', 'wpos-lite'); ?></th>
                <th data-column-id="total" data-sortable="false"><?php echo __( 'Total', 'wpos-lite'); ?></th>
                <th data-column-id="status" data-sortable="false"><?php echo __( 'Status', 'wpos-lite'); ?></th>
            </tr>
            </thead>
        </table>
    </form>
